...
def run_one(symbol, interval, bars, risk, mode, strategy_name):
    ...
    if strategy_name == "hybrid":
        ...
        if mode == "backtest":
            ...
            train_mask = [feat_valid[i] and label_valid[i] and i + horizon < split
        ...
        # Walk-forward mode
        segs = walk_forward_hybrid(data, p, bars_per_year=bpy,
                                   horizon=p.get("horizon", 20),
        ...
        for i, s in enumerate(segs):
            ...
            regime_str = (f'   [crab={rd.get("crab", 0)} trend={rd.get("trend", 0)} '
...
def main():
    ...
    ap.add_argument("--strategy", choices=["baseline", "crab", "hybrid"], default="hybrid")
